...
#include "C:\Users\Hardik\Desktop\juit\os project\sorting\b-tree.cpp"
#include "C:\Users\Hardik\Desktop\juit\os project\sorting\hashing.cpp"
#include "C:\Users\Hardik\Desktop\juit\os project\sorting\search.cpp"
#include "C:\Users\Hardik\Desktop\juit\os project\sorting\binarysearchtree.cpp"
...
int main()
{
    ...
    if (choice1 == 1) 
    {
        ...
        cout << "Press 2 for indexing using btree-search" << endl;
    ...
    else
    {
        ...
        FileSearch* search = new DirectorySearch();
